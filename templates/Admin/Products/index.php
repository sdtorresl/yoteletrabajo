    ...
    <div class="card-content">
        ...
        <table class="centered responsive-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $product->has('discount') ? $this->Html->link($product->discount->name, ['controller' => 'Discounts', 'action' => 'view', $product->discount->id]) : '' ?>
                    </td>
        ...
        <div class="row">
            <div class="d-flex jc-end">
                <?= $this->Html->link(__('Add product'), ['action' => 'add'], ['class' => 'btn']) ?>
            </div>
        </div>
    </div>
</section>
